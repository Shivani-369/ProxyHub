...
export default function MerchantOnboarding() {
  ...
  // Initialize and render the authentic Google Sign-In button for Merchants
  useEffect(() => {
          ...
          (window as any).google.accounts.id.initialize({
            ...
            callback: (response: any) => {
              ...
              if (profile && profile.email) {
                ...
                alert(`Successfully connected Google Account: ${profile.email}`);
              }
            }
          });

          (window as any).google.accounts.id.renderButton(
            document.getElementById("merchant-google-btn"),
          ...
          <div className="flex flex-col gap-5">
            ...
            {step === 1 && (
              <div className="flex flex-col gap-4 w-full">
                ...
                <div className="flex flex-col gap-2.5 pb-3 border-b border-indigo-500/10 w-full items-center">
                  <Label className="text-xs font-bold text-slate-350 self-start">Sign up with Google (Optional)</Label>
                  <div id="merchant-google-btn" className="w-full flex justify-center mt-1"></div>
                </div>
