...
export default function CustomerOnboarding() {
  ...
  const handleGoogleConnect = () => {
    ...
    setEmail("buyer.google@gmail.com");
  };
  ...
  const handleRetrieveGps = () => {
    ...
    setTimeout(() => {
      ...
      setCoords({ lat: 13.0425, lng: 80.2451 });
      setAddress("Plot 12A, Shanti Colony Main Road, Anna Nagar, Chennai 600040");
    }, 1200);
  };

  const handleComplete = () => {
    // Store onboarding info in localStorage for seamless dashboard login
    localStorage.setItem("customerEmail", "buyer.google@gmail.com");
    localStorage.setItem("customerAddress", "Plot 12A, Shanti Colony Main Road, Anna Nagar, Chennai 600040");
    localStorage.setItem("customerOnboarded", "true");
    
    // Redirect to home page with auto-login flags
            ...
            <div className="flex flex-col gap-5 w-full">
              ...
              {!isGoogleConnected ? (
                <Button 
                  ...
                  className="w-full bg-[#161a30] hover:bg-[#1e2445] text-slate-200 border border-indigo-500/20 text-xs font-bold h-12 rounded-xl flex items-center justify-center gap-2 transition-all"
                >
